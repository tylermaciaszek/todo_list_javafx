...
/**
 * This class serves as the application class for our To Do List program. 
 ...
 * @version 1.0
 */
public class ToDoListMaker extends AppTemplate {
    /**
	...
	return new AppComponentsBuilder() {
		...
		return new DataManager(ToDoListMaker.this);
	    }
		...
		return new Workspace(ToDoListMaker.this);
	    }
	};
    }
